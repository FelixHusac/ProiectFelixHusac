...
{
    class FirstClassTicket : PlaneTicket
    {
        ...
        public string GetTicketType() => "First Class";
        ...
        public FirstClassTicket(Holder holder, Tuple<String, String> places, double price, bool isCorporate)
        {
            _holder = holder;
