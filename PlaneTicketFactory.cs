...
namespace ProeictHusacFelix
{
    public abstract class PlaneTicketFactory
    {
        ...
        public PlaneTicket CreateTicket(Holder holder, Tuple<String, String> places, double price, bool isCorporate)
        {
            return this.MakeTicket(holder, places, price, isCorporate);
        }
    }
}
