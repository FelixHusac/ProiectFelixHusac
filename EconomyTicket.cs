...
{
    class EconomyTicket : PlaneTicket
    {
        ...
        public string GetTicketType() => "Economy Class";
        ...
        public EconomyTicket(Holder holder, Tuple<String, String> places, double price, bool isCorporate)
        {
            _holder = holder;
